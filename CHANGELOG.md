...
Todos los cambios relevantes de PixelFrame se registran en este archivo. El proyecto sigue [Semantic Versioning](https://semver.org/lang/es/): una versión `MAJOR.MINOR.PATCH` comunica cambios incompatibles, funciones nuevas compatibles y correcciones, respectivamente.
